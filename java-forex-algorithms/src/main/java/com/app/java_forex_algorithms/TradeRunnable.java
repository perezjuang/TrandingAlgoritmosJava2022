...
public class TradeRunnable implements Runnable {
	...
	static String login_token = "d2bfd668f956b8e60892a2ba1eb24705ab8731ef";
	...
	public static String sendPostRequest(String path, String param) {
		...
		try {
			...
			/*
			 * InputStream is = connection.getInputStream(); BufferedReader rd = new
			 * BufferedReader(new InputStreamReader(is)); String line; StringBuffer response
			 * = new StringBuffer(); while((line = rd.readLine()) != null) {
	...
	static void sendMarketOrder() throws Exception {
		if (accountID == "") {
			...
			String cmd = "account_id=" + accountID + "&symbol=EUR%2FUSD" + "&is_buy=true" + "&rate=0" + "&amount=2"
	...
	static void getHistoricalDataByOfferIDTimeFrame(String offerId, String timeFrame, String numberOfCandles)
			throws Exception {
	...
	static void getAccountIFO() throws Exception {
